                   ...
                   const float* const filter, const int filterWidth)
{
  ...
  int filter_radius = filterWidth/2;
  for (int filter_r = -filter_radius; filter_r <= filter_radius; ++filter_r) {
    for (int filter_c = -filter_radius; filter_c <= filter_radius; ++filter_c) {
      ...
      int filter_idx = (filter_r + filter_radius) * filterWidth + filter_c + filter_radius;
